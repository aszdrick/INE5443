...
dtstmtx = dataset.add_mutually_exclusive_group(required=True)
dtstmtx.add_argument("-e", "--test_set", type=str, metavar="FILE", help="Filename of the test set")
dtstmtx.add_argument("-d", "--data", type=str, metavar="FILE", help="Filename of the data to be classified")
dtstmtx.add_argument("-s", "--split", type=float, default=50, metavar="PERCENTAGE", help="Automatically pick the given approximate percentage of the input dataset to use as the test set")

dataset.add_argument("-o", "--output", type=str, default="out.csv", metavar="FILE", help="Save classified data as <FILE>.csv")
...
spiral.add_argument("-o", "--output", type=str, default="out.png", metavar="FILE", help="Save classified data as <FILE>.png")
